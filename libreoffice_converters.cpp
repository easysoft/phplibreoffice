	...
	try
	{
		...
		switch(type)
		{
			...
			case TypeClass_INTERFACE:
			{
				...
				libreoffice_class_instance_p->this_rsrc_id = rsrc_id;
				...
				libreoffice_class_instance_p->x_invoc_rsrc_id = rsrc_id;
				TEST_PTR(rsrc_id,retval);
				break;
			}
			...
			case TypeClass_STRUCT:
			{
				...
				rsrc_id = ZEND_REGISTER_RESOURCE (
						...
						uno_refer_rsrc_dtor);
				TEST_PTR(rsrc_id,retval);
				libreoffice_class_instance_p->x_idl_class_rsrc_id = rsrc_id;
				break;
			}
